...
class EngineFusionPipeline:
    ...
    def __init__(
        ...
        # ── Pre-allocated tensors for speed ──
        self._input_tensor = torch.zeros(1, 15, device=self.device)
        self._mask_tensor = torch.ones(1, 15, dtype=torch.bool, device=self.device)
