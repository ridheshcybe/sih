...
|---|---|---|---|---|---|---|
| anomaly | 0.9576 | 0.9729 | 0.9118 | 0.9378 | 0.9998 | NO |
...
|---:|---|---|---|---|
| 1 | anomaly | `rf_balanced_binary` | accuracy=0.9977, precision=0.9981, recall=0.9955, f1=0.9968, roc_auc=1.0000 | accuracy=0.9950, precision=0.9950, recall=0.9950, f1=0.9950, roc_auc=0.9998 |
